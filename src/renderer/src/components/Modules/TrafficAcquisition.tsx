            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden min-h-[400px]">
              <div className="p-8 border-b border-slate-50 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button className="px-3 py-1.5 bg-indigo-50 text-indigo-600 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all hover:bg-indigo-100">
                    批量生成
                  </button>
                </div>
              </div>
              <div className="p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div
                    key={i}
                    className="group p-6 bg-slate-50 rounded-[2rem] border border-transparent hover:border-indigo-100 hover:bg-indigo-50/30 transition-all cursor-pointer text-center"
                  >
              ...
              <div className="px-8 pb-8">
                <div className="bg-slate-900 rounded-[2rem] p-6 text-white relative overflow-hidden">
                  ...
                  <p className="mt-4 text-[10px] text-white/50 relative z-10">
                    视频渲染涉及服务器 GPU 资源，预计还需 1.5 小时...
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-indigo-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden">
              ...
              <div className="aspect-square bg-white/10 rounded-[2rem] border border-white/10 flex items-center justify-center mb-6 relative group overflow-hidden">
                ...
                />
                <p className="absolute bottom-6 text-[10px] font-bold text-white/40 uppercase tracking-widest">
                  点击或拖拽上传
                </p>
              </div>
              ...
              <tbody className="divide-y divide-slate-50">
                {[
                  ...
                  <tr key={i} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-8 py-6">
                      <span
                        className={`flex items-center gap-1.5 text-[10px] font-bold ${acc.status === 'Active' ? 'text-emerald-500' : 'text-amber-500'}`}
                      >
                        <div
      ...
      {subModule === 'CRM管理' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div className="bg-slate-50 p-6 rounded-[2rem] border border-slate-100">
                <p className="text-[10px] text-slate-400 font-bold uppercase mb-2 tracking-widest">
                  客户提问: "How soon do you ship to Germany?"
                </p>
                <div className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-slate-200" />
                  <div className="flex-1 bg-white p-4 rounded-2xl border border-slate-100 relative shadow-sm">
                    <p className="text-xs font-bold text-slate-700 leading-relaxed">
                      "Hi there! We usually process orders within 24 hours. Shipping to Germany
                      typically takes 5-7 business days via DHL. Would you like a shipping estimate
          ...
          <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm flex flex-col">
              ...
              {[
                {
                  ...
                  country: 'DE',
                  intent: 'High',
                  activity: 'Inquired about OEM'
                },
                {
                  name: 'Sarah Jenkins',
                  country: 'UK',
                  intent: 'Medium',
                  activity: 'Visited checkout 2x'
                },
                {
                  name: 'Yuki Tanaka',
                  country: 'JP',
                  intent: 'Low',
                  activity: 'Downloaded catalog'
                }
              ].map((lead, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between p-4 border border-slate-50 rounded-2xl hover:bg-slate-50 transition-all"
                >
                  ...
                  <span
                    className={`px-2.5 py-1 text-[9px] font-black uppercase rounded-lg ${
                      lead.intent === 'High'
            ...
            <button className="mt-8 w-full py-4 border-2 border-slate-100 text-slate-500 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-50 transition-all">
              同步至企业微信/飞书
            </button>
          </div>
        </div>
