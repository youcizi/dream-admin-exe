...
import { ChevronRight, Filter, Download, Plus, LayoutGrid, Search, BarChart2, Zap } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex justify-between items-end pb-2">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">{activeSubModule}</span>
              </div>
              <h1 className="text-3xl font-black text-slate-900 tracking-tight">{activeSubModule}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            {[
              ...
              <div key={stat.label} className="bg-white rounded-[2.5rem] p-8 border border-indigo-50 shadow-sm card-hover flex flex-col justify-between">
