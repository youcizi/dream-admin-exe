  ...
  return (
    <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="mb-10">
        ...
        <p className="text-slate-500 font-medium">配置您的 Cloudflare 凭据，以便系统能够代表您管理和部署应用。</p>
      </div>
      ...
      <div className="grid gap-8">
        ...
        <div className="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-xl shadow-slate-200/50 space-y-8 relative overflow-hidden group">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">用于授权 API 请求的令牌 (Wrangler 配置中使用)</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-[11px] text-slate-400 px-2 italic">提示：请确保令牌具有访问 Pages, Workers 和 D1 的权限。</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between px-6">
           <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">多账号支持即将推出</span>
           </div>
      ...
      <div className="mt-16 p-8 bg-blue-50/50 rounded-3xl border border-blue-100 flex gap-6 items-start">
         <div className="w-12 h-12 bg-white rounded-2xl shadow-sm flex items-center justify-center text-blue-500 shrink-0">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              登录您的 <a href="https://dash.cloudflare.com" target="_blank" rel="noreferrer" className="text-primary font-bold hover:underline">Cloudflare 控制台</a>。
              Account ID 可以在仪表盘右侧栏找到；API Token 可以在“我的个人资料 {"->"} API 令牌”中创建。
              建议使用“编辑 Cloudflare Workers”模板生成的令牌。
            </p>
      </div>
    </div>
  )
